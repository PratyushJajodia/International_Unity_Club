  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-sky-50 to-blue-100">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-semibold text-blue-700">Loading Events...</h2>
        <p className="text-blue-600">Please wait a moment while we fetch the latest programs.</p>
      </div>
    </div>
  );
} 